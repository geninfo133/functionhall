          ...
          <form onSubmit={handleSendOTP} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-lg"
                required
                maxLength={15}
              />
            </div>
              ...
              <div className="flex gap-2 justify-center">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-12 h-14 text-center text-2xl font-bold border-2 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  />
                ))}
              </div>
            </div>
