...
export default function AdminDashboard() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-orange-700 text-white py-6 px-8 shadow">
        <h1 className="text-3xl font-bold">Admin Dashboard</h1>
      </header>
      <main className="flex-1 p-8 max-w-4xl mx-auto">
        <nav className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/admin/halls" className="block bg-white rounded-xl shadow p-6 hover:bg-orange-50 border border-gray-200">
            <span className="text-xl font-semibold text-orange-500">Manage Halls</span>
            <p className="text-gray-600 mt-2">Add, edit, or delete function halls.</p>
          </Link>
          <Link href="/admin/packages" className="block bg-white rounded-xl shadow p-6 hover:bg-orange-50 border border-gray-200">
            <span className="text-xl font-semibold text-orange-7500">Manage Packages</span>
            <p className="text-gray-600 mt-2">Edit packages for each hall.</p>
          </Link>
          <Link href="/admin/bookings" className="block bg-white rounded-xl shadow p-6 hover:bg-orange-50 border border-gray-200">
        ...
        <section className="bg-white rounded-xl shadow p-6 border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-orange-700">Welcome, Admin!</h2>
